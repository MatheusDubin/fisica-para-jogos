...
### T1 — Consolidar Chuva canônica e regenerar RESULTS.md 🤖 ✅
...
- **Status:** ✅ obsoletos em `_arquivo-obsoleto/godot/`; RESULTS.md regenerado.
...
- **Status:** ✅ Torre lida por colapso; tempo-até-sleep secundário com ressalva.

### T4 — Torre N=100 no Unreal (Opção A ou B) 🤖 ✅ (Opção A — reenquadrado)
- **Depende de:** 👤 escolha A (reenquadrar, 🤖) ou B (você roda Unreal N=100).
- **Status:** ✅ Opção A — reenquadrado no sweep; N=100 Unreal = inferência documentada.
...
- **Status:** ✅ banners em STATUS/godot-NOTES/unity-NOTES/HANDOFF.
...
- **Status:** ✅ removida a causa 'iterações'; corrigido '4-5'→6; medido vs conjectura.
...
- **Status:** ✅ sublinear é geral (Unity 1.89× / Unreal 2.28×), não vantagem do Jolt.
...
## Decisões (respondidas 2026-07-01)
1. **T1:** ✅ **arquivar** os obsoletos (feito).
2. **T4:** ✅ **Opção A** — reenquadrar no sweep (feito).
